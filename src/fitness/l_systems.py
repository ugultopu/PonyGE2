...
class l_systems(base_ff):
    ...
    def evaluate(self, ind, **kwargs):
        ...
        if trackers.current_generation < params['GENERATIONS'] * .4: return 1 / ( max_y + 1 )
        elif trackers.current_generation < params['GENERATIONS'] * .6: return 1 / ( max_x + 1 )
        elif trackers.current_generation < params['GENERATIONS'] * .8: return 1 / ( max_y + 1 )
        else: return 1 / ( max_x + 1 )
