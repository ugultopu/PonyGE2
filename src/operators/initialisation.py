...
def initialisation(size):
    ...
    print("Before params['INITIALISATION'](size)")
...
def PI_grow(size):
    ...
    if size < 2:
        ...
        # Iterate over depths.
        print('type of depths are', type(depths))
        ...
        for depth in depths:
            ...
            for i in range(times):
                ...
                # Generate individual using "Grow"
                # print('Before generate_PI_ind_tree of "PI_grow"')
                print('Called generate_PI_ind_tree', generate_PI_ind_tree_call_counter, 'times.')
                if generate_PI_ind_tree_call_counter == 170:
                    pdb.set_trace()
                ind = generate_PI_ind_tree(depth)
                generate_PI_ind_tree_call_counter += 1
